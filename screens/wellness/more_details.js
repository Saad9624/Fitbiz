              ...
              >
                ...
                >
                  {item.ExerciseCount !== null ? 
                   <Text
                   style={{ color: 'black', fontSize: 12, marginHorizontal:10  }}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.props.navigation.navigate("EXERCISE_VISUALS", {
                        ...
                        WellnessExcerciseID:item.WellnessExcerciseID ,
                        WELLNESSBREAKID:item.WellnessBreakID
                      })
                    }
                    style={styles.start}
                  >
...
// URL http://fitbitzapi-env.4zm2regmgg.us-east-1.elasticbeanstalk.com/api/Wellness
// /GetWellnessExcerciseItems?username=Naveed&password=pass&wellnessBreakID=42